...
import { registerUserQuestion } from '../../services/userQuestionAPI';
...
const UserQuestionRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await registerUserQuestion(dataRegister);
      
      Swal.fire({
        icon: 'success',
        title: 'Registration Successful! 🎉',
        text: 'Your creator account has been created. Please login.',
        timer: 2000,
